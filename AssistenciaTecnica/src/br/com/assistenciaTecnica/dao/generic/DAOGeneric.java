...
public abstract class DAOGeneric<Entity> implements IDAOGeneric<Entity>
{
	...
	public DAOGeneric(){
		EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("db_varejo");
